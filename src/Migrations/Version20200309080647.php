 ...
 */
final class Version20200309080647 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE domaine (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(25) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE intervenant (id INT AUTO_INCREMENT NOT NULL, diplome_id INT DEFAULT NULL, emploi_id INT NOT NULL, nom VARCHAR(25) NOT NULL, prenom VARCHAR(25) NOT NULL, adresse VARCHAR(50) DEFAULT NULL, cp VARCHAR(6) DEFAULT NULL, tel_fixe INT DEFAULT NULL, tel_portable INT DEFAULT NULL, mail VARCHAR(50) NOT NULL, divers LONGTEXT DEFAULT NULL, name_cv VARCHAR(50) DEFAULT NULL, date_maj_cv DATE DEFAULT NULL, created_at DATE NOT NULL, INDEX IDX_73D0145C26F859E2 (diplome_id), INDEX IDX_73D0145CEC013E12 (emploi_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_emploi (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(25) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
